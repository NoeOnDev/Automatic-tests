...
// En esta prueba esperamos que el valor máximo de un array con números y cadenas de texto lance un error
...
// En esta prueba esperamos que el valor máximo de un array con números y undefined lance un error
test('Valor máximo de un array con números y undefined', () => {
    expect(() => maximo([1, 2, 3, undefined])).toThrow("El array contiene NaN");
});

// En esta prueba esperamos que el valor máximo de un array con números y NaN lance un error
